...
LANGUAGES = {
    ...
    "Belarusian": Language(
        ...
        alphabet=(
            u"АБВГДЕЁЖЗІЙКЛМНОПРСТУЎФХЦЧШЫЬЭЮЯ" u"абвгдеёжзійклмнопрстуўфхцчшыьэюяʼ"
        ),
    ...
    "Greek": Language(
        ...
        alphabet=(
            u"αβγδεζηθικλμνξοπρσςτυφχψωάέήίόύώ" u"ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΣΤΥΦΧΨΩΆΈΉΊΌΎΏ"
        ),
    ...
    "Hungarian": Language(
        ...
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(
            u"abcdefghijklmnoprstuvzáéíóöőúüű" u"ABCDEFGHIJKLMNOPRSTUVZÁÉÍÓÖŐÚÜŰ"
        ),
    ...
    "Lithuanian": Language(
        ...
        alphabet=(
            u"AĄBCČDEĘĖFGHIĮYJKLMNOPRSŠTUŲŪVZŽ" u"aąbcčdeęėfghiįyjklmnoprsštuųūvzž"
        ),
    ...
    "Latvian": Language(
        ...
        alphabet=(
            u"AĀBCČDEĒFGĢHIĪJKĶLĻMNŅOPRSŠTUŪVZŽ" u"aābcčdeēfgģhiījkķlļmnņoprsštuūvzž"
        ),
    ...
    "Macedonian": Language(
        ...
        alphabet=(
            u"АБВГДЃЕЖЗЅИЈКЛЉМНЊОПРСТЌУФХЦЧЏШ" u"абвгдѓежзѕијклљмнњопрстќуфхцчџш"
        ),
    ...
    "Polish": Language(
        ...
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(
            u"AĄBCĆDEĘFGHIJKLŁMNŃOÓPRSŚTUWYZŹŻ" u"aąbcćdeęfghijklłmnńoóprsśtuwyzźż"
        ),
    ...
    "Turkish": Language(
        ...
        alphabet=(
            u"abcçdefgğhıijklmnoöprsştuüvyzâîû" u"ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZÂÎÛ"
        ),
